...
class Box{
    ...
    surface(){
        return (2*this.small + this.large)*(2*this.medium + 2*this.small);
    }
    // finds which are the smallest, longest, and medium
    findSides(){
